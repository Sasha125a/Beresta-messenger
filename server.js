...
server.listen(PORT, () => {
    ...
    console.log('\n📞 Улучшенные аудиозвонки:');
    console.log('• Двусторонняя аудиосвязь');
    ...
    console.log('• Индикатор звонка и визуализатор звука');
    ...
    console.log('\n🔧 Отладка: Нажмите Ctrl+D в интерфейсе для включения панели отладки');
});
